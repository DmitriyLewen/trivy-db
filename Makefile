...
#	wget -qO - https://github.com/JuliaLang/SecurityAdvisories.jl/archive/refs/heads/generated/osv.tar.gz | tar xz -C $(CACHE_DIR)/julia --strip-components=1
	wget -qO - https://github.com/canonical/ubuntu-security-notices/archive/refs/heads/master.tar.gz | tar xz -C $(CACHE_DIR)/ubuntu-security-notices --strip-components=1
